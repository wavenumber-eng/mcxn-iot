...
__attribute((section("SRAMX"))) uint32_t my_ezh_program1[128]; // Todo relocate into fast SRAMX - no contention 
__attribute((section("SRAMX"))) uint32_t my_ezh_program2[128]; // Todo relocate into fast SRAMX - no contention 
__attribute((section("SRAMX"))) uint32_t my_ezh_program3[512]; // Todo relocate into fast SRAMX - no contention 
...
void ezh_app__spi_wr(void){
    ...
    E_HEART_RYTHM(32 * (150000000 / 10000000));
