...
#define CONFIG_IMX_USDHC 1
#define CONFIG_IMX_USDHC_DAT3_PWR_TOGGLE 1
#define CONFIG_IMX_USDHC_DMA_SUPPORT 1
#define CONFIG_SDHC_BUFFER_ALIGNMENT 4
#define CONFIG_IMX_USDHC_DMA_BUFFER_SIZE 128
#define CONFIG_SDHC_SUPPORTS_UHS 1
