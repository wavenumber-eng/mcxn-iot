...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_SERIES_MCXNX4X, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ETH_NXP_ENET_QOS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ETH_NXP_ENET_QOS_MAC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ETH_NXP_ENET_QOS_TX_BUFFER_DESCRIPTORS, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ETH_NXP_ENET_QOS_RX_BUFFER_DESCRIPTORS, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ETH_NXP_ENET_QOS_DMA_RESET_WAIT_TIME, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ETH_NXP_ENET_QOS_RX_THREAD_STACK_SIZE, 1024);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ETH_NXP_ENET_QOS_RX_THREAD_PRIORITY, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MDIO_NXP_ENET_QOS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MDIO_NXP_ENET_QOS_RECHECK_COUNT, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MDIO_NXP_ENET_QOS_RECHECK_TIME, 100);
